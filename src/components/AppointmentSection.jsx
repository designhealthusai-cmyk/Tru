...
const AppointmentSection = () => {
  ...
  return (
    <section
      className="relative bg-cover bg-center py-20 px-4 sm:px-8 md:px-16 lg:px-24 border-three border-b-[36px]"
    ...
    >
      ...
      <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-10 max-w-[1300px] mx-auto">
        ...
        {/* ✅ Form Section */}
        <div className="w-full md:w-1/2 order-1 md:order-2 bg-[#0F2145] text-white rounded-2xl p-6 sm:p-8 shadow-lg mt-12">
          <form
