...
const ContactFormSection = () => {
  ...
  return (
    <section
      className="relative bg-cover bg-center bg-no-repeat py-12 sm:py-16 px-4 sm:px-6"
      style={{
        backgroundImage: "url('/images/doctorimages.jpg')",
      }}
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto flex flex-col md:flex-row gap-8 items-start">
        ...
        <div className="w-full md:w-1/2 flex justify-center">
          <div className="bg-two rounded-xl p-6 sm:p-8 text-white shadow-lg max-w-lg w-full">
            <h2 className="text-2xl sm:text-3xl font-bold mb-3 sm:mb-4 text-one">
              Contact Us
            </h2>
            <p className="text-sm sm:text-base leading-relaxed">
              Fill out the form to schedule a consultation, ask a question, or share your
              health concerns. Our Trupeak team will respond within one business day.
            </p>
          </div>
        </div>
