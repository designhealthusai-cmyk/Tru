...
const pageData = {
  hero: {
    title: "Sexual Health",
    mainImage: "/images/ergogenic/ergogenic/sexual-health/2.webp", // Update if needed
    circleImage: "/images/ergogenic/ergogenic/sexual-health/1.webp" // Update if needed
  },

  overview: {
    description:
      "At Trupeak, we view sexual health as an essential part of overall well-being. Our discreet, evidence-based approach addresses root causes such as hormonal imbalance, circulatory issues, stress, or chronic illness to restore confidence and connection. Care begins with a full evaluation of hormones, metabolism, vascular health, and lifestyle, followed by a personalized plan that may include hormone balancing, peptide protocols, supplements, blood flow therapies, and for women, solutions for vaginal dryness, post-menopausal changes, and low arousal.",
    image: "/images/ergogenic/ergogenic/sexual-health/3.webp",
    reverse: true,
    bgColor: "",
    textColor: "text-two",
    ...
    procedures: [
      {
        ...
        description:
          "Includes hormone panel, metabolic testing, and circulatory review."
      },
      {
        title: "Hormonal Therapy (if needed)",
        description:
          "Administered and monitored by medical professionals."
      },
      {
        title: "Adjunctive Therapies",
        description:
          "Peptides, supplements, and blood flow enhancement protocols as per your treatment plan."
      }
    ]
  },
    ...
    faqs: [
      {
        ...
        answer:
          "No. We provide comprehensive care for both men and women, tailored to individual biology and life stage."
      },
      {
        question: "What kind of testing is involved?",
        answer:
          "We typically assess hormone levels, metabolic health, and circulation. Some cases may include advanced diagnostic imaging or stress markers."
      },
      {
        question: "Will I need to take hormones?",
        answer:
          "Not always. Hormone therapy is only recommended if clinically necessary. Many clients improve with peptides, supplements, or circulatory therapies alone."
      },
      {
        question: "Is this private and confidential?",
        answer:
          "Absolutely. All consultations and treatments are handled with complete discretion and patient privacy in mind."
      },
      {
        question: "Can this help post-menopause or after childbirth?",
        answer:
          "Yes. We offer specific solutions for vaginal dryness, reduced sensation, or hormonal changes related to life transitions."
      }
    ]
  }
};
